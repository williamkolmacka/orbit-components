...
class Tooltip extends React.PureComponent<Props, State> {
  ...
  setAlign = (position: Positions) => {
    ...
    if (possibleAligns.length > 0 && typeof possibleAligns[0] === "string") {
      this.setState({ align: possibleAligns[0] });
    } else if (windowWidth >= 600) {
      this.setPosition([POSITIONS.TOP, POSITIONS.BOTTOM]);
    }
  };
      ...
      <React.Fragment>
        ...
        <Portal>
          <StyledTooltip>
            ...
            >
              <StyledTooltipContent>{message}</StyledTooltipContent>
              <StyledTooltipClose>
